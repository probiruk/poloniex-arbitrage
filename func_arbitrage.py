            ...
            if pair_b != pair_a:
                if b_base in a_pair_box or b_quote in a_pair_box:
                    ...
                    for pair_c in pairs_list:
                        ...
                        # Count the number of match C items
...
def get_depth_from_orderbook(surface_arb):
    ...
    depth_1_prices = get_coin_ticker(url1)
    ...
    depth_2_prices = get_coin_ticker(url2)
    ...
    depth_3_prices = get_coin_ticker(url3)
